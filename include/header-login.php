...
<div class="loader-bg"></div>
        ...
        <div class="mn-content <?= $sidebarClass ?>">
                ...
                <nav class="white">
                    <div class="nav-wrapper row">
                        ...
                        <ul class="right col s9 m3 nav-right-menu">
                            <li class=""><a href="javascript:void(0)" data-activates="dropdown1" class="dropdown-button dropdown-right"><span class="icon-vkv-icons-set-33"></span></a></li>
                            <li class=""><a href="javascript:void(0)" data-activates="dropdown1" class="dropdown-button dropdown-right"><span class="icon-vkv-icons-set-23"></span></a></li>
                        </ul>
