            ...
            <div class="col s12 m7">
              <div class='ys-login-form gradientPinkHorizontal'>
                <form class="row">
                  ...
                  <div class="input-field col s12">
                      <i class="icon-password-1 prefix"></i>
                  ...
                  <div class="input-field col s12">
                      <i class="icon-password-1 prefix"></i>
                      <input id="icon_prefix" type="password" class="validate">
                      <label for="icon_prefix" class="">Confirm Password</label>
                  </div>
                  <div class="input-field col s12">
                      <input type="checkbox" class="filled-in white" id="filled-in-box-example">
                      <label for="filled-in-box-example">I agree to the <a class="modal-trigger" href="#tnc">Terms & Conditions</a></label>
                  </div>
                  <div class="input-field col s12">
                     <button class="btn btn-large waves-effect btn-ys-center waves-light white btn-rounded">Lets Get Started</button>
                  </div>
                </form>
              </div>
            </div>
