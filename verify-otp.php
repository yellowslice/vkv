          ...
          <div class='ys-login-box row'>
            <div class="col s12 m7">
              ...
              <div class='ys-login-form gradientPinkHorizontal'>
                <form class="row">
                  <p class="center-align">04:15</p>
                  <h3 class="center-align">Verify Email</h3>
                  ...
                  <div class="input-field col s12">
                      <a href="#" class="center-align">Resend OTP for email</a>
                  </div>
                </form>

                <form class="row">
                  <h3 class="center-align">Verify Mobile</h3>
                  <div class="input-field otp-field col s3">
                      <input id="icon_prefix" type="text" class="validate" maxlength="1">
                      <label for="icon_prefix" class=""></label>
                  </div>
                  ...
                  <div class="input-field col s12">
                      ...
                      <a class="center-align" href="#" >Resend OTP for mobile</a>
                  </div>
                  <div class="input-field col s12">
